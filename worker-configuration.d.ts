/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: dacff06f32d6d661633167a1a67d8bdb)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		SAFE_SCRIPT_URL: string;
		MALICIOUS_SCRIPT_URL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SAFE_SCRIPT_URL" | "MALICIOUS_SCRIPT_URL">> {}
}
